...
export interface HeatingRecommendation { estimatedHeatDemandKw: number | null; recommendedFlowTemperatureC: number | null; recommendedBoilerPowerKw: number | null; confidence: RecommendationConfidence; similarLogCount: number; reason: string; capacityWarning: string | null; referenceLog?: HeatingLog | null; noHeatingDemand?: boolean; }
